...
import {teamselected,setvalues} from "./winslice"
...
function Bet() {
    ...
    function Match(){
        ...
        return(
            ...
            <button  onClick={()=>goto(valueone.Team2)} disabled={disable}>{valueone.Team1}</button>
            <button  onClick={()=>goto(valueone.Team1)} disabled={disable}>{valueone.Team2}</button>
